jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,blocks,threedflipwithzoom,threedwithzoom,threedflip,cssslide,threedtiles,kenburns,threedhorizontalwithzoom,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
